...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	...
	public AnnotationConfigApplicationContext() {
		// 这一行代码，内部往AnnotationConfigApplicationContext的DefaultListableBeanFactory
		// 的beanDefinitionMap中添加了5个基础类
	...
	public AnnotationConfigApplicationContext(Class<?>... componentClasses) {
		// 这里调用无参数构造，应该是在准备环境
		// 在构造方法中都已经把DefaultListableBeanFactory准备好了
		this();
		// 通过AnnotatedBeanDefinitionReader(this()构造方法中创建的reader)将配置类变成了beanDefinition
